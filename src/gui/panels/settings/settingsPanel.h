...
class SettingsPanel
{
    ...
    private:
        ...
        float m_phase0Color[4] = { Config::phase0Color.r, Config::phase0Color.g, Config::phase0Color.b, Config::phase0Color.a };
        float m_phase1Color[4] = { Config::phase1Color.r, Config::phase1Color.g, Config::phase1Color.b, Config::phase1Color.a };
